...
**What is theme-based highlighting?** Theme-based highlighting is the ability to categorize theme names and assign them to specific highlight colors. You can then use these colors to organize your transcript/book according to blocks of themes, improving categorization and ideation. 
